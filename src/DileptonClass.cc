...
void DileptonClass::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("electronPair_l1_SmearE", electronPair_l1_SmearE, &b_electronPair_l1_SmearE);
   ...
   fChain->SetBranchAddress("electronPair_l2_SmearE", electronPair_l2_SmearE, &b_electronPair_l2_SmearE);
