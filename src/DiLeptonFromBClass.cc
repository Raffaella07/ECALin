...
void DiLeptonFromBClass::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("BToKEE_l1_SC_EOverP", BToKEE_l1_SC_EOverP, &b_BToKEE_l1_SC_EOverP);
   fChain->SetBranchAddress("BToKEE_l1_SC_Energy", BToKEE_l1_SC_Energy, &b_BToKEE_l1_SC_Energy);
   fChain->SetBranchAddress("BToKEE_l1_SC_RegEnergy", BToKEE_l1_SC_RegEnergy, &b_BToKEE_l1_SC_RegEnergy);
   fChain->SetBranchAddress("BToKEE_l1_SC_rawEnergy", BToKEE_l1_SC_rawEnergy, &b_BToKEE_l1_SC_rawEnergy);
   fChain->SetBranchAddress("BToKEE_l1_SCeta", BToKEE_l1_SCeta, &b_BToKEE_l1_SCeta);
   fChain->SetBranchAddress("BToKEE_l1_SCphi", BToKEE_l1_SCphi, &b_BToKEE_l1_SCphi);
   ...
   fChain->SetBranchAddress("BToKEE_l2_SC_EOverP", BToKEE_l2_SC_EOverP, &b_BToKEE_l2_SC_EOverP);
   fChain->SetBranchAddress("BToKEE_l2_SC_Energy", BToKEE_l2_SC_Energy, &b_BToKEE_l2_SC_Energy);
   fChain->SetBranchAddress("BToKEE_l2_SC_RegEnergy", BToKEE_l2_SC_RegEnergy, &b_BToKEE_l2_SC_RegEnergy);
   fChain->SetBranchAddress("BToKEE_l2_SC_rawEnergy", BToKEE_l2_SC_rawEnergy, &b_BToKEE_l2_SC_rawEnergy);
   fChain->SetBranchAddress("BToKEE_l2_SCeta", BToKEE_l2_SCeta, &b_BToKEE_l2_SCeta);
   fChain->SetBranchAddress("BToKEE_l2_SCphi", BToKEE_l2_SCphi, &b_BToKEE_l2_SCphi);
